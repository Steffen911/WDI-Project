...
public class ModelFuserLongestString extends AttributeValueFuser<String, Car, Attribute> {

	public ModelFuserLongestString(ConflictResolutionFunction<String, Car, Attribute> conflictResolution) {
