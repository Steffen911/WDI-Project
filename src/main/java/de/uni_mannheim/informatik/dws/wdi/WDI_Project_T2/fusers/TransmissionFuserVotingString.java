...
public class TransmissionFuserVotingString extends AttributeValueFuser<String, Car, Attribute> {

    public TransmissionFuserVotingString() {
        super(new Voting<>());
    }
    ...
    public void fuse(RecordGroup<Car, Attribute> group, Car fusedRecord, Processable<Correspondence<Attribute, Matchable>> correspondence, Attribute elem) {
        ...
        fusedRecord.setAttributeProvenance(Car.TRANSMISSION, fused.getOriginalIds());
