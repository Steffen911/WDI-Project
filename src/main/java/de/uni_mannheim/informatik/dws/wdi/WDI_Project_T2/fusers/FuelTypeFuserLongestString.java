...
public class FuelTypeFuserLongestString extends AttributeValueFuser<String, Car, Attribute> {

    public FuelTypeFuserLongestString() {
        super(new LongestString<>());
    }

    @Override
    public boolean hasValue(Car c, Correspondence<Attribute, Matchable> correspondence) {
        return c.hasValue(Car.FUEL_TYPE);
    }
